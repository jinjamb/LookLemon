...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-4RBEL4AU.js");
      } else {
        await import("./rgbdDecode.fragment-P7PEIKAU.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-WOQ6USGA.js");
    } else {
      await import("./rgbdEncode.fragment-ATQMTHM6.js");
    }
...
async function CreateEnvTextureAsync(texture, options = {}) {
  ...
  for (let i = 0; i <= mipmapsCount; i++) {
    ...
    for (let face = 0; face < 6; face++) {
      ...
      const imageEncodedData = await DumpDataAsync(faceWidth, faceWidth, rgbdEncodedData, imageType, void 0, false, true, options.imageQuality);
...
//# sourceMappingURL=chunk-P3B6TPAH.js.map
