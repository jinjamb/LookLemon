import {
  PostProcessManager,
  RenderingManager
} from "./chunk-MXYHWUN6.js";
import {
  PerfCounter
} from "./chunk-3WKCZ4KQ.js";
import {
  BaseTexture,
  Texture
...
} from "./chunk-NYQLLFDQ.js";
import {
  EffectWrapper
} from "./chunk-CQQV4Z5K.js";
import {
  SmartArray
} from "./chunk-BBTNXBAW.js";
import {
  SerializationHelper
} from "./chunk-MSAKOUDF.js";
import {
  Color3,
  __decorate,
  serialize,
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-JRTGOTVF.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-RLBIN6FM.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-XAR6K5UI.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-3JXFCU6P.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-S2ULGU6V.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-NOCKQY7Y.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-BFH6HL7C.js");
    } else {
      await import("./lod.fragment-4EV2JXK6.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-PB4XTNH5.js");
    } else {
      await import("./lod.fragment-G2LA5KGO.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-5536VMZ7.js.map
