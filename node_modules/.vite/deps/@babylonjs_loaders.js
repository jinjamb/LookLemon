...
import {
  Animation,
  Bone
} from "./chunk-7GOXOCGZ.js";
import "./chunk-W7BX4MFA.js";
import "./chunk-P3B6TPAH.js";
import "./chunk-U5RN4EBM.js";
import "./chunk-WKXRXUEO.js";
import "./chunk-QDXIFF52.js";
import "./chunk-KGASU6XJ.js";
import {
  RenderTargetTexture,
  SphericalHarmonics,
  SphericalPolynomial
} from "./chunk-5536VMZ7.js";
import "./chunk-MXYHWUN6.js";
import "./chunk-3WKCZ4KQ.js";
import {
  Texture
} from "./chunk-MAXN6NIL.js";
import "./chunk-YC7U4GEU.js";
import "./chunk-UOYNNPUW.js";
import "./chunk-NYQLLFDQ.js";
import "./chunk-CP7NKYYV.js";
import "./chunk-CQQV4Z5K.js";
import {
  AbstractMesh,
  BoundingInfo,
  Camera,
...
import "./chunk-Z6QFG26Y.js";
import "./chunk-KVRDKYGD.js";
import "./chunk-WDMGI7RE.js";
import "./chunk-Y35ILOKK.js";
import "./chunk-ZXVFJ3IO.js";
import "./chunk-CCQAAKQU.js";
import "./chunk-BBTNXBAW.js";
import "./chunk-5AQS7OFY.js";
import "./chunk-MSAKOUDF.js";
import {
  Color3,
  Color4
...
import "./chunk-OUPBUJNI.js";
import {
  Buffer,
  GetTypedArrayConstructor,
  VertexBuffer
} from "./chunk-XNP7MCPG.js";
import {
  Tools
} from "./chunk-OYD6W6VU.js";
import {
...
var AnimationPropertyInfo = class {
  /** @internal */
  constructor(type, name2, getValue, getStride) {
    this.type = type;
    this.name = name2;
    this.getValue = getValue;
    this.getStride = getStride;
  }
  _buildAnimation(name2, fps, keys) {
    const babylonAnimation = new Animation(name2, this.name, fps, this.type);
    babylonAnimation.setKeys(keys);
...
var TransformNodeAnimationPropertyInfo = class extends AnimationPropertyInfo {
  /** @internal */
  buildAnimations(target, name2, fps, keys, callback) {
    callback(target._babylonTransformNode, this._buildAnimation(name2, fps, keys));
  }
};
  ...
  buildAnimations(target, name2, fps, keys, callback) {
    if (target._numMorphTargets) {
      for (let targetIndex = 0; targetIndex < target._numMorphTargets; targetIndex++) {
        const babylonAnimation = new Animation(`${name2}_${targetIndex}`, this.name, fps, this.type);
...
var GLTFLoader2 = class _GLTFLoader {
  ...
  loadAnimationAsync(context, animation) {
    ...
    return import("./animationGroup-ORKF5QKL.js").then(({ AnimationGroup }) => {
      this._babylonScene._blockEntityCollection = !!this._assetContainer;
    ...
    return this._loadAnimationSamplerAsync(`${animationContext}/samplers/${channel.sampler}`, sampler).then((data) => {
      ...
      for (const propertyInfo of propertyInfos) {
        ...
        if (outputOffset > 0) {
          ...
          propertyInfo.buildAnimations(target, name2, fps, keys, (babylonAnimatable, babylonAnimation) => {
            ++numAnimations;
...
var KHR_materials_variants = class _KHR_materials_variants {
  ...
  onReady() {
    ...
    if (rootNode) {
      (_b = (_a = this._loader.parent.extensionOptions[NAME18]) == null ? void 0 : _a.onLoaded) == null ? void 0 : _b.call(_a, {
        get variants() {
          return _KHR_materials_variants.GetAvailableVariants(rootNode);
        },
        get selectedVariant() {
...
var CameraAnimationPropertyInfo = class extends AnimationPropertyInfo {
  /** @internal */
  buildAnimations(target, name2, fps, keys, callback) {
    callback(target._babylonCamera, this._buildAnimation(name2, fps, keys));
  }
};
var MaterialAnimationPropertyInfo = class extends AnimationPropertyInfo {
  ...
  buildAnimations(target, name2, fps, keys, callback) {
    for (const fillMode in target._data) {
      callback(target._data[fillMode].babylonMaterial, this._buildAnimation(name2, fps, keys));
    }
  }
};
var LightAnimationPropertyInfo = class extends AnimationPropertyInfo {
  /** @internal */
  buildAnimations(target, name2, fps, keys, callback) {
    callback(target._babylonLight, this._buildAnimation(name2, fps, keys));
  }
};
var nodesTree = {
  __array__: {
...
registerGLTFExtension(NAME34, false, (loader) => new ExtrasAsMetadata(loader));
